...
\lstinputlisting[language=VHDL,label=code:hardhist, basicstyle=\footnotesize,  caption={Histograma via Hardware},firstline=291, lastline=381, firstnumber=291]{../camera_interface.vhd}
