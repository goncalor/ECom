...
\lstinputlisting[language=C,label=code:histograma, caption=\texttt{histogram.c}]{codigo/histogram.c}
...
\lstinputlisting[language=C,label=code:embossing, caption=\texttt{embossing.c}]{codigo/embossing.c}
